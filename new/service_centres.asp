...
<title>FusionExcel - Service Centres - FE's New Corporate Headquarter Opening Ceremony 8pm 8th August 2011</title>
    ...
    <tr>
        <td valign="top">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <!--#include file="render_service_centre_list.asp" -->
                </tr>
                <tr>
